...
const (
	...
	P503_MaskAliceByte1 = 0x03
	// Length of secret key for A and B is the same - don't mask anything
	P503_MaskAliceByte2 = 0xFF
	P503_MaskAliceByte3 = 0xFF // OZAPTF: I don't know what's a good value for this
	// Corresponds to (8 - e3 % 8). Used for ensuring bitlength equal to e3
	P503_MaskBobByte = 0x0F
