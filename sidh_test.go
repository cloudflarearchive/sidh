...
func BenchmarkAliceKeyGenFast(b *testing.B) {
	...
	for n := 0; n < b.N; n++ {
		keygenBenchPubKeyAlice = aliceSecretKey.PublicKey()
	}
}
...
func BenchmarkBobKeyGenFast(b *testing.B) {
	...
	for n := 0; n < b.N; n++ {
		keygenBenchPubKeyBob = bobSecretKey.PublicKey()
	}
}
...
func BenchmarkKeyAgreementAliceFast(b *testing.B) {
	...
	for n := 0; n < b.N; n++ {
		benchKeyAgreementJInvariant = aliceSecret.SharedSecret(&benchKeyAgreementBobPublic)
	}
}
...
func BenchmarkKeyAgreementBobFast(b *testing.B) {
	...
	for n := 0; n < b.N; n++ {
		benchKeyAgreementJInvariant = bobSecret.SharedSecret(&benchKeyAgreementAlicePublic)
	}
}
